...
let Particles = class Particles extends Vue {
    mounted() {
        this.$nextTick(() => {
            ...
            tsParticles.load(this.id, (_a = this.options) !== null && _a !== void 0 ? _a : {}).then(container => this.particlesContainer = container);
        });
    }
    beforeDestroy() {
        var _a;
        (_a = this.particlesContainer) === null || _a === void 0 ? void 0 : _a.destroy();
    }
};
__decorate([
    Prop({ required: true })
...
const VueParticles = (Vue$1, options) => {
